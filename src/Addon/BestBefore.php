...
class BestBefore extends Base\Addon implements Interfaces\Addon {
    ...
    public function __construct() {
        ...
        // Set up cron
        // @todo remove cron when plugin deactivated
        if (!wp_next_scheduled('bbx_best_before_cron')) {
            wp_schedule_event(strtotime('1am'), 'daily', 'bbx_best_before_cron');
        }
        add_action('bbx_best_before_cron', array($this, 'execute_cron'));
    }
